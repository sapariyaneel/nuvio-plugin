// rogmovies.js
// RogMovies (https://new1.rogmovies.click) - same backend/theme family as vegamovies.js (site brands
// itself "Vegamovies Official" and shares nexdrive.fit/vcloud.zip/hubcloud infra), Typesense-backed search
